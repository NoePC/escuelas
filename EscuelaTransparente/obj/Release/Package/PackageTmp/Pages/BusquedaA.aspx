...
<body>
    <form id="form1" runat="server">
        ...
        <div id="modalReg">
            ...
            <br />
            <asp:Button ID="btRegitrarse" runat="server"  ForeColor="White" Text="Registrarse" OnClick="btRegitrarse_Click"/>
        </div>
        ...
        <div id="Coment-foto">
            ...
            <asp:Button ID="btEnviar" runat="server"  ForeColor="White" Text="Enviar" OnClick="btEnviar_Click1" style="margin-left:380px;"/>
        </div>
